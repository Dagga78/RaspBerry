...
class Piezo {
    ...
    fun win(){
        ...
        playmusic(Piezo.Note.NOTE_B5, 53)
        delay(53)
        playmusic(Piezo.Note.NOTE_B5, 53)
        delay(53)
        playmusic(Piezo.Note.NOTE_B5, 53)
        delay(53)
        playmusic(Piezo.Note.NOTE_B5, 428)
        delay(10)
        playmusic(Piezo.Note.NOTE_G5, 428)
        delay(10)
        playmusic(Piezo.Note.NOTE_A5, 428)
        delay(10)
        playmusic(Piezo.Note.NOTE_B5, 107)
        delay(214)
        playmusic(Piezo.Note.NOTE_A5, 107)
        delay(10)
        playmusic(Piezo.Note.NOTE_B5, 857)
        delay(10)
    ...
    fun lose() {
        playmusic(Note.NOTE_A5, 500)
        delay(10)
        playmusic(Note.NOTE_A4, 500)
        delay(10)
        playmusic(Note.NOTE_A3, 500)
        delay(10)
        playmusic(Note.NOTE_A2, 1000)
        delay(10)
    }
